...
@interface YQSellCarViewController ()

@end

@implementation YQSellCarViewController
...
- (void)setBaseView {
    ...
    bgImageView.image = [UIImage imageNamed:@"sellCar-bg"];
    ...
    titleImageView.image = [UIImage imageNamed:@"sellCarHeaderTitle-bg"];
    ...
    [button setTitle:@"马上登记" forState:UIControlStateNormal];
...
- (void)nextButtonClick:(UIButton *)button {
    YQSellCarInfoViewController *infoVC = [[YQSellCarInfoViewController alloc] init];
